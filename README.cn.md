...
合计: **2,171,141** 行代码（覆盖前 5 种语言、共 **9150** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| TypeScript | 998,109 | 110,492 | 75,712 | 3363 |
...
- **Star**: 95,475 · **Fork**: 11,065 · **开放 issue**: 1,933 · **贡献者**: 438

## 累计统计

- **发布数**: 35 · **已合并 PR**: 3320 · **开放 PR**: 503 · **已关闭 issue**: 1452 · **开放 issue**: 481 · **提交数**: 3600
...
在 [repology.org](https://repology.org/project/open-design) 上共有 **3** 个发行版报告此项目。**2** 个 ✅ 已是最新上游版本，**0** 个 ⚠️ 使用旧版本。
...
_数据快照: `data/card/260911.yml` · 2026-09-11T05:26:41Z._
